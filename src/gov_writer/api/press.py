...
- 각 단락 " ○ "로 시작
- 첫 단락: 추진 배경·필요성
- 중간 단락: 주요 내용 (정책 세부, 시행일·대상·예산 등)
- 후반 단락: 기대 효과·향후 계획

[기관장 인용문 단락 — 필수]
- 본문 후반에 반드시 기관장(장관·도지사·시장 등) 인용문 1개 이상 포함
- 형식: " ○ ○○○ ○○○○지사는 \\"...\\"라며, \\"...\\"라고 밝혔다."
- 원본에 인용문이 없어도 사업 취지·기대효과를 바탕으로 자연스럽게 구성
- 인용문은 직접 인용 부호("...") 사용, 발언자 직책·이름 명시
...
## 본문 단락 (body_paragraphs) — 5~7개 권장
각 단락 " ○ "로 시작 (앞 공백 1개 + ○ + 공백 1개).

순서:
1. 첫 단락: 추진 배경·필요성 (왜 이 사업을 시작하나)
2~4. 중간 단락: 주요 내용 (정책 세부, 분야별 사업, 시행일·대상·예산 등)
5. **기관장 인용문 단락 — 필수**
   - 형식: " ○ ○○○ ○○○○지사는 \\"...\\"라며, \\"...\\"라고 밝혔다."
...
# 3. 기관장 인용문 — 절대 빠뜨리지 말 것
한국 정부 보도자료는 거의 100% 기관장 인용문을 포함합니다.
